...
# спрашиваем сколько учебных дней
while True:
    try:
        ...
        if day < 1:
            ...
            break  # если правильно (выход из цикла)
    except ValueError:
...
# список хранения часов
hours_list = []

# спрашиваем количество часов для каждого дня
    ...
    while True:
        try:
            ...
            if hours < 0:
                ...
                break  # Все правильно, выходим из цикла
        except ValueError:
